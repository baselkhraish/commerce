                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-3 fw-bold fs-7">{{ $product->count() }} منتج محذوف</span>
                                </h3>
                            </div>
                            <div>
                                <a href="{{ route('admin.product.index') }}" class="btn btn-sm btn-primary">كل المنتجات</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-150px">السعر بعد الخصم</th>
                                            <th class="min-w-150px">الكمية</th>
                                            <th class="min-w-150px">القسم</th>
                                        ...
                                        @foreach ($product as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <p class="text-dark fw-bolder text-hover-primary fs-6">
                                                            <img src="{{ asset('uploads/images/products/' . $item->image) }}"
                                                                alt="" width="50">
                                                        </p>
                                                    </div>
                                                </td>
