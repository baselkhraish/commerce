<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="#">
            <img alt="Logo" src="{{ asset('adminasset/assets/images/BaselIcon.jpeg') }}" class="h-25px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                {{-- Dashboard --}}
                <div class="menu-item {{ Route::is('admin.index') ? 'here show' : '' }}">
                    <a class="menu-link py-3 {{ Route::is('admin.index') ? 'active' : '' }}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item {{ Route::is('admin.category.*') ? 'here show' : '' }} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.category.index') ? 'active' : '' }}"
                                href="{{ route('admin.category.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">عرض الأقسام</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('category.create') ? 'active' : '' }}"
                                ...
                                <span class="menu-title">إنشاء قسم جديد</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.category.trash') ? 'active' : '' }}"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.product.index') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('product.create') ? 'active' : '' }}"
                                href="{{ route('admin.product.create') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">إنشاء منتج جديد</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.product.trash') ? 'active' : '' }}"
                ...
                <div class="menu-item {{ Route::is('admin.order') ? 'here show' : '' }}">
                    <a class="menu-link py-3 {{ Route::is('admin.order') ? 'active' : '' }}"
                ...
                {{-- Payment --}}
                <div class="menu-item {{ Route::is('admin.payment') ? 'here show' : '' }}">
                    <a class="menu-link py-3 {{ Route::is('admin.payment') ? 'active' : '' }}"
