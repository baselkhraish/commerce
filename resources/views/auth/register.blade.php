...
<body>
    <div class="container">
        <main class="signup-container">
            ...
            <p class="text-mute">Enter your credentials to create new account.</p>
            ...
            <form class="signup-form" method="POST" action="{{ route('register') }}">
                ...
                <label class="inp">
                    <input id="password_confirmation" type="password" class="input-text "
            ...
            <p class="text-mute">Already member? <a href="{{ route('login') }}">Sign in</a></p>
        </main>
